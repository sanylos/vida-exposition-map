...
const ExpositionCard = ({ exposition }: { exposition: Exposition }) => {
    return (
        <div style={{
            ...
            className="my-1 lg:my-0 lg:mx-1 h-48 w-full bg-cover bg-start hover:bg-center flex flex-col items-center justify-between bg-white rounded-lg shadow md:flex-row">
