...
const ExpositionCard = ({ exposition }: { exposition: Exposition }) => {
    return (
        <div style={{
            ...
            className="bg-cover bg-start hover:bg-center mb-1 flex flex-col items-center justify-between bg-white rounded-lg shadow md:flex-row md:max-w-xl">
            ...
            <MdArrowForwardIos className="text-6xl text-gray-100 shadow-2xl me-2" />
        </div>
