...
const ExpositionCard = ({ exposition }: { exposition: Exposition }) => {
    return (
        <div style={{
            ...
            className="my-1 2xl:my-0 h-3 md:h-80 2xl:h-52 2xl:mb-1 2xl:mx-1 h-48 w-full bg-cover bg-start hover:bg-center flex flex-row items-center justify-between bg-white rounded-lg shadow">
