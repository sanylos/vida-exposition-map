      ...
      <body className={inter.className}>
        <nav className="navbar navbar-expand-xl navbar-dark bg-black position-relative px-xl-5 bg-cyan-900" style={{ height: '5.5rem' }}>
          <div className="flex justify-start items-center h-full w-auto">
            <svg className="p-1" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="143.455px" height="59px" viewBox="56.772 0 143.455 59" enable-background="new 56.772 0 143.455 59" xmlSpace="preserve"><g id="Layer_1_1_"></g><g id="Layer_2"></g><g id="Layer_3"><g>
